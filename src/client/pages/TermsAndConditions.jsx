...
const CONTENT = {
  ro: {
    docTitle: "Termeni și Condiții – Complete Pizza",
    ...
    s2p1: ["Complete Pizza pune la dispoziție o platformă online pentru comandarea produselor alimentare (pizza artizanală, deserturi și băuturi) cu livrare la domiciliu sau ridicare de la pizzerie, în zona orașului ", "Sebeș, județul Alba", "."],
    ...
    s3list: [
      ...
      "Complete Pizza poate suspenda sau șterge conturile care încalcă acești termeni",
    ...
    s7warn: ["Conform art. 16 lit. d) din OUG 34/2014, ", "dreptul de retragere NU se aplică", " contractelor privind bunuri care se deteriorează rapid sau care expiră repede – categorie în care intră produsele alimentare comandate de la Complete Pizza. Odată preparate, comenzile nu pot fi returnate sau rambursate, cu excepția cazurilor prevăzute la art. 8."],
    ...
    s9warn: ["Produsele noastre pot conține sau pot veni în contact cu alergenii declarați în descrierile din meniu. Dacă ai alergii sau intoleranțe alimentare, contactează-ne înainte de comandă la ", "+40 (123) 456-7890", ". ", "Complete Pizza nu poate garanta un mediu complet lipsit de alergeni.", ""],
    ...
    s10p: "Toate elementele platformei (logo, design, fotografii, texte, cod sursă) sunt proprietatea exclusivă a Complete Pizza sau sunt utilizate cu licență. Este interzisă reproducerea, distribuirea sau utilizarea comercială fără acordul scris al Complete Pizza.",
    s11title: "11. Limitarea răspunderii",
    s11list: [
      "Complete Pizza nu răspunde pentru daune indirecte sau pierderi de profit cauzate de întârzieri în livrare",
  ...
  en: {
    docTitle: "Terms & Conditions – Complete Pizza",
    ...
    s2p1: ["Complete Pizza provides an online platform for ordering food products (artisan pizza, desserts and drinks) with home delivery or pickup from the pizzerie, in the area of ", "Sebeș, Alba County", "."],
    ...
    s3list: [
      ...
      "Complete Pizza may suspend or delete accounts that violate these terms",
    ...
    s7warn: ["Pursuant to art. 16(d) of OUG 34/2014, the ", "right of withdrawal DOES NOT APPLY", " to contracts for goods that deteriorate rapidly or expire quickly — a category that includes food products ordered from Complete Pizza. Once prepared, orders cannot be returned or refunded, except as provided in art. 8."],
    ...
    s9warn: ["Our products may contain or come into contact with the allergens declared in the menu descriptions. If you have food allergies or intolerances, please contact us before ordering at ", "+40 (123) 456-7890", ". ", "Complete Pizza cannot guarantee a completely allergen-free environment.", ""],
    ...
    s10p: "All elements of the platform (logo, design, photographs, texts, source code) are the exclusive property of Complete Pizza or are used under licence. Reproduction, distribution or commercial use without the written consent of Complete Pizza is prohibited.",
    s11title: "11. Limitation of Liability",
    s11list: [
      "Complete Pizza is not liable for indirect damages or loss of profit caused by delivery delays",
