...
const CONTENT = {
  ro: {
    docTitle: "Politica de Livrare – Complete Pizza",
    title: "Politica de Livrare",
    updated: "Ultima actualizare: 4 mai 2026",
    intro: ["Această politică descrie condițiile de livrare și ridicare a comenzilor de la ", "Complete Pizza", ", conform ", "OUG nr. 34/2014", " privind drepturile consumatorilor în contractele la distanță și Legea nr. 365/2002 privind comerțul electronic."],
    c1title: "Timp de livrare", c1val: "25–45 minute estimat", c1sub: "Depinde de distanță și volum",
    c2title: "Zonă de livrare",   c2val: "Sebeș + împrejurimi",      c2sub: "Max. 10 km de pizzerie",
    c3title: "Taxă de livrare",   c3val: "15 RON (standard)",         c3sub: "Afișată înainte de plată",
    s1title: "1. Zona de livrare",
    s1p1: ["Livrăm comenzi în ", "municipiul Sebeș", " și localitățile limitrofe în raza de ", "maximum 10 kilometri", " față de locația curentă a pizzerie-ului."],
    ...
    s1p3: "Complete Pizza este un pizzerie mobil. Locația se poate schimba zilnic. Verifică locația curentă pe platformă sau pe paginile noastre de social media.",
    ...
    s3list: [
      ...
      ["Ridicare personală", " de la pizzerie: fără taxă de livrare, fără comandă minimă"],
    ],
    ...
    s4list2: [
      "Selectezi opțiunea „Ridicare de la pizzerie\" la checkout",
      "Vei fi notificat când comanda este gata (estimat 10–20 minute)",
      "Locația exactă a pizzerie-ului este afișată pe platformă",
    ],
  ...
  en: {
    docTitle: "Delivery Policy – Complete Pizza",
    title: "Delivery Policy",
    updated: "Last updated: 4 May 2026",
    intro: ["This policy describes the conditions for delivery and pickup of orders from ", "Complete Pizza", ", in accordance with ", "Government Emergency Ordinance no. 34/2014", " on consumer rights in distance contracts and Law no. 365/2002 on electronic commerce."],
    c1title: "Delivery time",  c1val: "25–45 minutes (estimated)", c1sub: "Depends on distance and volume",
    c2title: "Delivery zone",  c2val: "Sebeș + surroundings",       c2sub: "Max. 10 km from pizzerie",
    c3title: "Delivery fee",   c3val: "15 RON (standard)",           c3sub: "Shown before payment",
    s1title: "1. Delivery Zone",
    s1p1: ["We deliver orders in ", "the city of Sebeș", " and surrounding localities within a maximum of ", "10 kilometres", " from the pizzerie's current location."],
    ...
    s1p3: "Complete Pizza is a mobile pizzerie. Location may change daily. Check the current location on our platform or social media pages.",
    ...
    s3list: [
      ...
      ["Personal pickup", " at the pizzerie: no delivery fee, no minimum order"],
    ],
    ...
    s4list2: [
      "Select 'Pickup from pizzerie' at checkout",
      "You will be notified when your order is ready (estimated 10–20 minutes)",
      "The exact location of the pizzerie is shown on the platform",
    ],
    ...
    s8p: "Complete Pizza is not liable for delays caused by: extreme weather conditions, natural disasters, restrictions imposed by authorities, pandemics, exceptional traffic, or other events beyond our control. In such situations, we will contact you to reschedule or cancel your order with a full refund.",
